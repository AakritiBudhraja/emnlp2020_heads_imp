...
def define_data_download_flags():
  ...
  flags.DEFINE_string(
      name="data_dir", short_name="dd", default="/scratch/scratch2/aakriti/working_official_aakriti_changes/models/official/transformer/data/ende/",
      help=flags_core.help_wrap(
          "Directory for where the translate_ende_wmt32k dataset is saved."))
  flags.DEFINE_string(
      name="raw_dir", short_name="rd", default="/scratch/scratch2/aakriti/working_official_aakriti_changes/models/official/transformer/data/ende/",
      help=flags_core.help_wrap(
