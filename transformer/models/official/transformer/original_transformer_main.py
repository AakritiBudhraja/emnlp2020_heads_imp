...
def get_learning_rate(learning_rate, hidden_size, learning_rate_warmup_steps, checkpoint_step = 0, constant_learning_rate = 1000.0):
  print("****** CONSTANT LEARNING RATE IS : {} ******".format(constant_learning_rate))
  """Calculate learning rate with linear warmup and rsqrt decay."""
  with tf.name_scope("learning_rate"):
    if constant_learning_rate == 1000.0: 
        ...
        learning_rate = tf.convert_to_tensor(constant_learning_rate)
        tf.identity(learning_rate, "learning_rate")
...
def get_train_op_and_metrics(loss, params):
  ...
  with tf.variable_scope("get_train_op"):
    learning_rate = get_learning_rate(
        ...
        constant_learning_rate = params["constant_learning_rate"])
...
def define_transformer_flags():
  ...
  flags.DEFINE_float(
      name="constant_learning_rate", default=1000.0,
      help=flags_core.help_wrap(
...
def construct_estimator(flags_obj, params, schedule_manager):
  ...
  if not params["use_tpu"]:
    ...
    return tf.estimator.Estimator(
        ...
        config=tf.estimator.RunConfig(train_distribute=distribution_strategy, save_checkpoints_steps=43430, keep_checkpoint_max=5))
...
def run_transformer(flags_obj):
  ...
  params["constant_learning_rate"] = flags_obj.constant_learning_rate
