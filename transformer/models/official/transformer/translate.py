...
def translate_file(
  ...
  for i, prediction in enumerate(predictions):
    ...
    # Collecting attention weights of each sentence in the batch.
...
def translate_text(estimator, subtokenizer, txt):
  ...
  predictions = estimator.predict(input_fn)
  translation = next(predictions)
  #print (translation)
  translation, attn_weights = translation["outputs"], translation["attn_weights"]
...
def define_translate_flags():
  ...
  flags.DEFINE_string(
      name="concrete_heads", default="['enc-self' , 'dec-self' , 'enc-dec']",  # 'enc-self' , 'dec-self' , 'enc-dec'
      help=flags_core.help_wrap(
