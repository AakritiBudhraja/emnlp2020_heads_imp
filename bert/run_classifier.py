...
flags.DEFINE_integer("save_checkpoints_steps", 114,
...
flags.DEFINE_bool("apply_rp", False, "Whether to apply random pruning or not.")

flags.DEFINE_string("pruning_mask", "", "Random pruning mask to be applied on encoder self attention.")
...
def main(_):
  ...
  model_fn = model_fn_builder(
      ...
      pruning_mask=FLAGS.pruning_mask)
  ...
  if FLAGS.do_predict:
    ...
    result = estimator.predict(input_fn=predict_input_fn,checkpoint_path="gs://aakriti__bucket/rp/4epochs_32bs/model.ckpt-228")
